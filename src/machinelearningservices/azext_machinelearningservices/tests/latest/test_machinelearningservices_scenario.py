...
def step__workspaces_put_create_workspace(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices workspace create '
             ...
             checks=[
                 ...
                 test.check("encryption.keyVaultProperties.keyIdentifier", "https://testkv.vault.azure.net/keys/testkey"
                            "/aabbccddee112233445566778899aabb", case_sensitive=False),
                 test.check("encryption.keyVaultProperties.keyVaultArmId", "/subscriptions/{subscription_id}/resourceGr"
                            "oups/{rg}/providers/Microsoft.KeyVault/vaults/testkv", case_sensitive=False),
...
def step__machinelearningcompute_put2(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             ...
             '--location "eastus" '
             '--properties-properties "{{\\"remoteLoginPortPublicAccess\\":\\"NotSpecified\\",\\"scaleSettings\\":{{\\"'
             'maxNodeCount\\":1,\\"minNodeCount\\":0,\\"nodeIdleTimeBeforeScaleDown\\":\\"PT5M\\"}},\\"vmPriority\\":\\'
...
def step__machinelearningcompute_put3(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             '--compute-name "compute123" '
             '--location "eastus" '
             '--properties-properties "{{\\"applicationSharingPolicy\\":\\"Personal\\",\\"sshSettings\\":{{\\"sshPublic'
...
def step__machinelearningcompute_put4(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             '--compute-name "compute123" '
             '--location "eastus" '
             '--properties-properties "{{\\"vmSize\\":\\"STANDARD_NC6\\"}}" '
             '--resource-group "{rg_3}" '
             '--workspace-name "{myWorkspace2}"',
             checks=[])
...
def step__machinelearningcompute_put6(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             ...
             '--properties-properties "{{\\"agentCount\\":4}}" '
             '--resource-id "/subscriptions/{subscription_id}/resourcegroups/{rg_3}/providers/Microsoft.ContainerServic'
...
def step__machinelearningcompute_put7(test, rg, rg_2, rg_5, rg_3, rg_4, rg_6, rg_7):
    test.cmd('az machinelearningservices machine-learning-compute aks create '
             ...
             'ups/myResourceGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/identity-name\\":{{}}}}" '
             '--location "eastus" '
             '--properties-properties "{{\\"scaleSettings\\":{{\\"maxNodeCount\\":1,\\"minNodeCount\\":0,\\"nodeIdleTim'
             'eBeforeScaleDown\\":\\"PT5M\\"}}}}" '
             '--resource-group "{rg_3}" '
             '--workspace-name "{myWorkspace2}"',
             checks=[])
