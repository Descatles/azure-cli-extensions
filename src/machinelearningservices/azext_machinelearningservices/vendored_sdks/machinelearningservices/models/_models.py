...
class ComputeInstance(Compute):
    ...
    _attribute_map = {
        ...
        'application_sharing_policy': {'key': 'properties.applicationSharingPolicy', 'type': 'str'},
        'ssh_settings': {'key': 'properties.sshSettings', 'type': 'ComputeInstanceSshSettings'},
        'connectivity_endpoints': {'key': 'properties.connectivityEndpoints', 'type': 'ComputeInstanceConnectivityEndpoints'},
        'applications': {'key': 'properties.applications', 'type': '[ComputeInstanceApplication]'},
        'created_by': {'key': 'properties.createdBy', 'type': 'ComputeInstanceCreatedBy'},
        'errors': {'key': 'properties.errors', 'type': '[MachineLearningServiceError]'},
        'state': {'key': 'properties.state', 'type': 'str'},
        'last_operation': {'key': 'properties.lastOperation', 'type': 'ComputeInstanceLastOperation'},
        'id': {'key': 'properties.subnet.id', 'type': 'str'},
    }
