...
def load_command_table(self, _):
    ...
    devops_pipeline_template_definition = CliCommandType(
        operations_tmpl='azext_devops.vendored_sdks.1.operations._pipeline_template_definition_operations#PipelineTempl'
        'ateDefinitionOperations.{}',
    ...
    devops_pipeline = CliCommandType(
        operations_tmpl='azext_devops.vendored_sdks.1.operations._pipeline_operations#PipelineOperations.{}',
