...
def load_arguments(self, _):
    ...
    with self.argument_context('portal tenant-configuration show') as c:
        pass

    with self.argument_context('portal tenant-configuration create') as c:
        c.argument('enforce_private_markdown_storage', arg_type=get_three_state_flag(), help='Flag to enforce URI stora'
                   'ge for Markdown tiles in Private dashboards.')

    with self.argument_context('portal tenant-configuration delete') as c:
        pass
