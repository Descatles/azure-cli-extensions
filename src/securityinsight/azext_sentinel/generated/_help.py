...
:15:30Z" --created-by object-id="2046feea-040d-4a46-9e2b-91c2941bfa70" --display-name "My bookmark" --labels "[\\"Tag1\
\\",\\"Tag2\\"]" --notes "Found a suspicious activity" --query "SecurityEvent | where TimeGenerated > ago(1d) and TimeG\
enerated < ago(2d)" --query-result "Security Event query result" --updated "2019-01-01T13:15:30Z" --updated-by object-i\
d="2046feea-040d-4a46-9e2b-91c2941bfa70" --bookmark-id "73e01a99-5cd7-4139-a149-9f2736ff2ab5" --resource-group "myRg" -\
-workspace-name "myWorkspace"
"""
