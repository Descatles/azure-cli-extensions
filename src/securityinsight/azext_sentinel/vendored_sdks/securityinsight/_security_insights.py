...
class SecurityInsights(object):
    ...
    :vartype operation: azure.mgmt.securityinsight.operations.OperationOperations
    ...
    :vartype action: azure.mgmt.securityinsight.operations.ActionOperations
    :ivar alert_rule_template: AlertRuleTemplateOperations operations
    :vartype alert_rule_template: azure.mgmt.securityinsight.operations.AlertRuleTemplateOperations
    ...
    :vartype data_connector: azure.mgmt.securityinsight.operations.DataConnectorOperations
    :ivar incident: IncidentOperations operations
    :vartype incident: azure.mgmt.securityinsight.operations.IncidentOperations
    :ivar incident_comment: IncidentCommentOperations operations
    :vartype incident_comment: azure.mgmt.securityinsight.operations.IncidentCommentOperations
