...
class BookmarkOperations(object):
    ...
    def list(
     ...
     name is case insensitive.
        ...
        :return: BookmarkList or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.BookmarkList
    ...
    def create_or_update(
        ...
        created_by=None,  # type: Optional["models.UserInfo"]
        ...
        updated_by=None,  # type: Optional["models.UserInfo"]
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Bookmark or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.Bookmark or ~azure.mgmt.securityinsight.models.Bookmark
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Bookmark"]
        error_map = kwargs.pop('error_map', {404: ResourceNotFoundError, 409: ResourceExistsError})

        _bookmark = models.Bookmark(etag=etag, created=created, created_by=created_by, display_name=display_name, labels=labels, notes=notes, query=query, query_result=query_result, updated=updated, updated_by=updated_by, incident_info=incident_info)
        api_version = "2020-01-01"
