...
helps['datafactory factory create'] = """
    ...
    examples:
      - name: Factories_CreateOrUpdate
        text: |-
               az datafactory factory create --location "East US" --github-configuration account-name="githubAccount" c\
ollaboration-branch="githubBranch" repository-name="githubRepo" root-folder="folderName" --factory-name "exampleFactory\
...
helps['datafactory factory reset-factory-repo'] = """
    type: command
    short-summary: Updates a factory's repo information.
    examples:
      - name: Factories_ConfigureFactoryRepo
        text: |-
               az datafactory factory reset-factory-repo --factory-resource-id "/subscriptions/12345678-1234-1234-1234-\
12345678abc/resourceGroups/exampleResourceGroup/providers/Microsoft.DataFactory/factories/exampleFactoryName" --vsts-co\
nfiguration account-name="ADF" collaboration-branch="master" last-commit-id="" project-name="project" repository-name="\
repo" root-folder="/" tenant-id="" --location-id "East US"
"""
...
helps['datafactory pipeline create'] = """
    ...
    examples:
      - name: Pipelines_Create
        text: |-
               az datafactory pipeline create --factory-name "exampleFactoryName" --activities "[{\\"name\\":\\"Example\
