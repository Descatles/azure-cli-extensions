...
class FactoryOperations:
    ...
    async def configure_factory_repo_for_demo(
        self,
        location_id: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.configure_factory_repo_for_demo.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str'),
        ...
        return deserialized
    configure_factory_repo_for_demo.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.DataFactory/locations/{locationId}/configureFactoryRepoForDemo'}
